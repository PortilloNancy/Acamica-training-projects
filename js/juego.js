...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_vertical.png', 170, 455, 30, 30, 1),
    ...
    new Obstaculo('imagenes/bache.png', 170, 265, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 500, 130, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 800, 440, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 70, 220, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 350, 390, 30, 15, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 800, 200, 15, 30, 1),
  ...
  enemigos: [
    new ZombieCaminante("imagenes/zombie1.png",200,200,10,10,2,{desdeX: 0, hastaX:961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante("imagenes/zombie2.png",100,100,10,10,2,{desdeX: 0, hastaX:961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante("imagenes/zombie3.png",100,100,10,10,2,{desdeX: 0, hastaX:961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante("imagenes/zombie4.png",100,100,10,10,2,{desdeX: 0, hastaX:961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante("imagenes/zombie1.png",200,200,10,10,1,{desdeX: 0, hastaX:961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante("imagenes/zombie2.png",100,500,10,10,3,{desdeX: 0, hastaX:961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante("imagenes/zombie3.png",100,400,10,10,1,{desdeX: 0, hastaX:961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante("imagenes/zombie4.png",100,450,10,10,2,{desdeX: 0, hastaX:961, desdeY: 0, hastaY: 577}),
    new ZombieConductor("imagenes/tren_horizontal.png",400,324,90,30,10,{desdeX: 0, hastaX:961, desdeY: 0, hastaY: 577},'h'),
    new ZombieConductor("imagenes/tren_vertical.png",674,0,30,90,10,{desdeX: 0, hastaX:961, desdeY: 0, hastaY: 577},'v'),
...
Juego.capturarMovimiento = function (tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    de sus metodos  */
    this.jugador.movimientos(movX, movY,tecla);
    /* COMPLETO!!! */
...
Juego.dibujar = function () {
  ...
  // Dibuja la meta
  Dibujante.dibujarImagen("imagenes/salida.png",768,510,110,50);
...
Juego.calcularAtaques = function () {
  this.enemigos.forEach(function (enemigo) {
    if (this.intersecan(enemigo, this.jugador, this.jugador.x, this.jugador.y)) {
      ...
      //ZombieCaminante.prototype.dejarDeAtacar();
...
Juego.chequearColisiones = function (x, y) {
  ...
  this.obstaculos().forEach(function (obstaculo) {
    if (this.intersecan(obstaculo, this.jugador, x, y)) {
      ...
      /*COMPLETO!!, obstaculo debe chocar al jugador*/
